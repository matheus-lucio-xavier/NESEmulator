...
// Retorna o valor de um bit especifico do status register
uint8_t olc6502::GetFlag(FLAGS6502 f)
{
	return ((status & f) > 0) ? 1 : 0;
}

// Define ou limpa um bit especifico do status register
...
// Essa funcao lida com opcodes desconhecidos
uint8_t olc6502::XXX()
{
	return 0;
}
